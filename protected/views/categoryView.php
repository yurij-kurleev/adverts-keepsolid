...
<div class="page-navigation-block">
    <a href="#" id="prev" class="page-navigation-link"
       onclick="ajaxPagination(this, '/index/category/' + <?=$post['id_cat']?> + '/', '/ajax/category/' + <?=$post['id_cat']?>); return false;"> < </a>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        repaintPaginationBar(document.getElementById("cur").firstChild.nodeValue * 1, "/ajax/category/"+ <?=$post['id_cat']?>);
    });
</script>
