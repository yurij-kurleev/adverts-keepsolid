...
<div class="page-navigation-block">
    <a href="#" id="prev" class="page-navigation-link" onclick="ajaxPagination(this, '/index/index/', '/ajax/index'); return false;"> < </a>
    <a href="#" id="cur" class="page-navigation-link" onclick="return false;"> 1 </a>
    <a href="#" id="next" class="page-navigation-link" onclick="ajaxPagination(this, '/index/index/', '/ajax/index'); return false;"> > </a>
</div>
<?php endif; ?>
<script src="/js/search.js"></script>
<script>
    document.addEventListener("DOMContentLoaded", function() {
        repaintPaginationBar(document.getElementById("cur").firstChild.nodeValue * 1, "/ajax/index");
    });
</script>
